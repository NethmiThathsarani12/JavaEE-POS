...
$("#txtOrderItemCode").click(function () {
    ...
    $.ajax({
        url: "http://localhost:8080/backEnd/item?option=get",
        method: "GET",
        success: function (resp) {
...
function generateOrderID(){
    ...
    $.ajax({
        url: "http://localhost:8080/backEnd/order?option=Id",
        method: "GET",
        success: function (resp) {
...
function loadAllOrders() {
    $("#orderTable").empty();
    $.ajax({
        url: "http://localhost:8080/backEnd/order?option=get",
        method: "GET",
        dataType: "json",
        success: function (res) {
            console.log(res);
...
function loadAllOrderDetails() {
    ...
    $.ajax({
        url: "http://localhost:8080/backEnd/order?option=orderDetail",
        method: "GET",
        dataType: "json",
        success: function (res) {
            console.log(res);
